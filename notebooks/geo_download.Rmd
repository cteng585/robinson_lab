...
rgset <- loadRDS("~/github_repos/robinson_lab/bin/GSE115508.rds")
```
...
```{r}
robinson_check_sex <- function(rgset) {
...
```
```{r}
methylated_intensities <- minfi::getMeth(rgset)
unmethylated_intensities <- minfi::getUnmeth(rgset)
```
